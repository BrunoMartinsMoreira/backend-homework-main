    ...
    const proposals = [
      {
        ...
        userCreatorId: 1,
        customerId: 1,
        createdAt: new Date('2024-01-01T19:20:00').toISOString(),
        updatedAt: new Date('2024-01-01T19:20:00').toISOString(),
      },
      {
        profit: 456,
        status: 'SUCCESSFUL',
      ...
      },
      {
        ...
        userCreatorId: 3,
        customerId: 3,
        createdAt: new Date('2024-01-04T19:20:00').toISOString(),
        updatedAt: new Date('2024-01-04T19:20:00').toISOString(),
      },
      {
        profit: 234,
        status: 'ERROR',
        userCreatorId: 4,
        customerId: 4,
        createdAt: new Date('2024-01-14T07:20:00').toISOString(),
        updatedAt: new Date('2024-01-14T07:20:00').toISOString(),
      },
      {
        profit: 567,
        status: 'PENDING',
        userCreatorId: 5,
        customerId: 5,
        createdAt: new Date('2024-01-20T19:20:00').toISOString(),
        updatedAt: new Date('2024-01-20T19:20:00').toISOString(),
      },
      {
        profit: 890,
        status: 'PENDING',
        userCreatorId: 1,
        customerId: 6,
        createdAt: new Date('2024-01-13T21:20:00').toISOString(),
        updatedAt: new Date('2024-01-13T21:20:00').toISOString(),
      },
      {
        profit: 123,
        status: 'PENDING',
        userCreatorId: 2,
        customerId: 7,
        createdAt: new Date('2024-01-23T23:20:00').toISOString(),
        updatedAt: new Date('2024-01-23T23:20:00').toISOString(),
      },
      {
        profit: 456,
        status: 'SUCCESSFUL',
        userCreatorId: 3,
        customerId: 8,
        createdAt: new Date('2023-12-01T10:20:00').toISOString(),
        updatedAt: new Date('2023-12-01T10:20:00').toISOString(),
      },
      {
        profit: 789,
        status: 'REFUSED',
        userCreatorId: 4,
        customerId: 9,
        createdAt: new Date('2024-01-02T03:20:00').toISOString(),
        updatedAt: new Date('2024-01-02T03:20:00').toISOString(),
      },
      {
        profit: 234,
        status: 'ERROR',
        userCreatorId: 5,
        customerId: 10,
        createdAt: new Date('2024-01-05T07:20:00').toISOString(),
        updatedAt: new Date('2024-01-05T07:20:00').toISOString(),
      },
      {
        profit: 567,
        status: 'PENDING',
        userCreatorId: 1,
        customerId: 11,
        createdAt: new Date('2024-01-17T05:20:00').toISOString(),
        updatedAt: new Date('2024-01-17T05:20:00').toISOString(),
      },
      {
        profit: 890,
        status: 'PENDING',
        userCreatorId: 2,
        customerId: 12,
        createdAt: new Date('2024-01-20T03:20:00').toISOString(),
        updatedAt: new Date('2024-01-20T03:20:00').toISOString(),
      },
      {
        profit: 123,
        status: 'PENDING',
      ...
      },
      {
        ...
        updatedAt: new Date('2024-01-15T15:20:00').toISOString(),
      },
      {
        profit: 789,
        status: 'REFUSED',
        ...
        updatedAt: new Date('2024-01-10T13:20:00').toISOString(),
      },
    ];
